...
export default function TestimonialsSection() {
  return (
    <section className="py-20 px-6 bg-aire-pink relative overflow-hidden">
      ...
      <div className="container mx-auto relative z-10">
        <div className="text-center mb-16">
          <h2 className="font-bold text-aire-white mb-4">
            COMO AJUDAMOS
            <br />
            NOSSOS PACIENTES?
          </h2>
        ...
        <div className="flex flex-col items-center">
          <Card className="bg-white border-none shadow-lg my-[10px] max-w-[1000px]">
            <CardContent className="p-8 px-12">
              <p className="text-aire-purple text-center font-bold leading-relaxed text-lg">
              ...
              <p className="text-aire-purple text-center leading-relaxed text-md mt-5">
        ...
        <div className="text-center mt-12 flex justify-center">
          <Button className="text-lg bg-aire-purple hover:bg-aire-blue text-white px-6 py-3 lg:flex items-center space-x-2 shadow-lg">
